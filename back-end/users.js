...
router.post('/', async (req, res) => {
  ...
  // malformed.
  if (!req.body.firstName || !req.body.lastName || !req.body.username || !req.body.password || !req.body.address || !req.body.email)
    return res.status(400).send({
      message: "first name, last name, address, email, username and password are required"
    });
